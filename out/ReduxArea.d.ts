...
declare class Area<TBaseState, TAreaState, TBaseFailureAction extends Func, TAreaFailureAction extends Func, TBaseActionTypeInterceptor extends ActionCreatorInterceptor> {
    ...
    add(name: string, tags?: string[]): {
        ...
        reducer: (reducer: (state: Immutable<TAreaState & TBaseState>) => any) => AreaAction<TBaseState, TAreaState, () => {}, ReturnType<TBaseActionTypeInterceptor>>;
        /**
        ...
        */
        action: <TAction extends Func>(action: TAction) => {
            ...
            reducer: (reducer: (state: Immutable<TAreaState & TBaseState>) => any) => AreaAction<TBaseState, TAreaState, TAction, ReturnType<TBaseActionTypeInterceptor>>;
        };
    };
    /**
    ...
    protected reduceMethod: <TAction extends Func>(actionName: string, name: string, actionTags: string[], action: TAction, reducer: (state: Immutable<TBaseState & TAreaState>, reducerAction: TAction) => any) => AreaAction<TBaseState, TAreaState, TAction, ReturnType<TBaseActionTypeInterceptor>>;
    protected reduceMethodEmpty: (name: string, actionName: string, actionTags: string[], reducer: (state: Immutable<TBaseState & TAreaState>) => TBaseState & TAreaState) => AreaAction<TBaseState, TAreaState, () => {}, ReturnType<TBaseActionTypeInterceptor>>;
